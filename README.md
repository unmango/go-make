...
| conditional comments              | `ifeq (a,b) # comment text`                     |                    |                    |                    | kept in the body as a `CommentGroup` and printed on its own line, [#112](https://github.com/unmango/go-make/issues/112)       |
