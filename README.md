...
| semicolon delimited recipes       | `target: ; recipe`                              | :white_check_mark: | :white_check_mark: |                    | `target:; recipe` parses, `target: ;recipe` is still one pre-requisite, [#112](https://github.com/unmango/go-make/issues/112) |
